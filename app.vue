      ...
      >
        <nav class="md:flex md:items-center md:justify-between">
          ...
          >
            ...
            <button
              class="w-full px-5 py-3 transition-colors duration-300 bg-gray-100 rounded-md dark:bg-gray-800 md:w-auto md:mx-6 hover:bg-gray-200 dark:hover:bg-gray-700"
            >
              <div class="flex items-center justify-center -mx-1">
                <p class="mx-1 text-sm text-gray-600 dark:text-white">
                  Coming Soon
                </p>
        ...
        <section class="flex items-center justify-center flex-1">
          <div class="flex flex-col w-full">
            <div class="flex items-center justify-center">
              <img src="@/assets/transparent.png" class="w-60" />
            </div>
            <h1
              class="text-5xl font-extrabold text-center lg:text-7xl 2xl:text-8xl bg-gradient-to-r from-orange-400 to-cyan-900 bg-clip-text text-transparent"
            >
              Coming Soon
            </h1>
            ...
            >
              Nepal's first Global B2B Marketing Agency.
            </p>
